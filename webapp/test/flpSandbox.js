		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comexamplecountphysicalinventory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplecountphysicalinventory-display": {
								"semanticObject": "comexamplecountphysicalinventory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.countphysicalinventory",
									"url": sap.ui.require.toUrl("com/example/countphysicalinventory")
								}
							}
						}
					}
